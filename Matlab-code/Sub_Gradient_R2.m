% -------------------------------------------------------------------------------------------------
% Function: Sub_Gradient_R2 (Rule 2).
...
%           ** Note that different to Rule 1, in Rule 2 "lambda" value are 
%              updated inside the function (within "while - end" loop). So, 
%              it is no longer an input parameter pre-set outside the 
%              function as in the case of rule R1.
%
% Output parameters:
...
% --------------------------------------------------------------------------------------------------
function [h, A, D] = Sub_Gradient_R2 (n, C, UB)
...
while (TSP == 0)
      ...
      % At iteration k, update value of step "lambda" according to Rule 2.
      lamda = 1/k;       
